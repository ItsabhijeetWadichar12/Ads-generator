        ...
        <div className='p-5 shadow rounded-xl'>
            ...
            <div className='mt-3'>
                ...
                <Textarea className={'text-xl'}
                    ...
                    value={videoData?.script || (videoData?.scriptVariant && videoData?.scriptVariant[0]?.content) || ''} />
            </div>
            ...
            <div className='grid grid-cols-3 gap-3 mt-3'>
                {videoData?.scriptVariant && videoData?.scriptVariant.length > 0 ? (
                    ...
                    <div className="col-span-3 text-center p-3 text-gray-500">
                        No script variants available
                    </div>
                )}
            </div>
        </div>
